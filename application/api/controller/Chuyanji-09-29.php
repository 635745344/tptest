...
//        $this->mem = MemcacheInstance::getInstance (); // 采用单例模式调用Memcached
    ...
    public function initEquipment()
    {
        ...
        $equipment_id=input('equipment_id');
         ...
         if(empty($registration_id) || empty($equipment_id)){
        ...
        if($check_equipment){ 
            ...
            Db::name('equipment')->where(['equipment_id'=>$equipment_id])->update(['registration_id'=>$registration_id]);
        ...
        P(['registration_id'=>$registration_id,'equipment_id'=>$equipment_id,'new_code'=>$new_code,'check_equipment'=>$check_equipment]);

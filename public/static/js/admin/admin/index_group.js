...
$(function (){
    ...
    $.extend($.m.admin,{
        ...
        //退出登录
        login_out:function (){
          $.get('/group/login/login_out',{},function (data){
              if(data.status==1){
        ...
        new:function (){
          var html='';
          $.get('/group/adminLog/new_log',{},function (data){
            html+='<li>'+
                  '<a href="#">'+
        ...
        //加载首页
        load_home:function(){
            $('#content_1510826929').load('/group/admin/index3');
        },
        //选择公众号
        select_wx:function (){
       ...
       edit_pwd_modal_id=$.f.modal.create_form({obj:$('#form_edit_pwd_1510826929'),title:'修改密码',btn:[
              {
                ...
                click:function(){
                    ...
                    $.get('/group/admin/edit_pwd',{ password:password1_val },function (data){
                      if(data.status==1){
